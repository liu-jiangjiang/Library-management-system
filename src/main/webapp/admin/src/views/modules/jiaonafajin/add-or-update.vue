<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借阅单号" prop="jieyuedanhao">
          <el-input v-model="ruleForm.jieyuedanhao" 
              placeholder="借阅单号" clearable  :readonly="ro.jieyuedanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借阅单号" prop="jieyuedanhao">
              <el-input v-model="ruleForm.jieyuedanhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="罚款说明" prop="fakuanshuoming">
          <el-input v-model="ruleForm.fakuanshuoming" 
              placeholder="罚款说明" clearable  :readonly="ro.fakuanshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="罚款说明" prop="fakuanshuoming">
              <el-input v-model="ruleForm.fakuanshuoming" 
                placeholder="罚款说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="罚款金额" prop="fakuanjine">
          <el-input v-model="ruleForm.fakuanjine" 
              placeholder="罚款金额" clearable  :readonly="ro.fakuanjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="罚款金额" prop="fakuanjine">
              <el-input v-model="ruleForm.fakuanjine" 
                placeholder="罚款金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="罚款日期" prop="fakuanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.fakuanriqi" 
                type="date"
                placeholder="罚款日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fakuanriqi" label="罚款日期" prop="fakuanriqi">
              <el-input v-model="ruleForm.fakuanriqi" 
                placeholder="罚款日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.fakuanriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushumingcheng = true;
          ...
          if(o=='fakuanshuoming'){
            this.ruleForm.fakuanshuoming = obj[o];
	    this.ro.fakuanshuoming = true;
            continue;
          }
          if(o=='fakuanjine'){
	    ...
	    this.ro.fakuanjine = true;
          ...
          if(o=='fakuanriqi'){
            this.ruleForm.fakuanriqi = obj[o];
	    this.ro.fakuanriqi = true;
            continue;
          }
          if(o=='yonghuming'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiaonafajin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaonafajinCrossAddOrUpdateFlag = false;
                  this.parent.search();
