<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="图书分类" prop="tushufenlei">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="图书状态" prop="tushuzhuangtai">
          <el-select v-model="ruleForm.tushuzhuangtai" placeholder="请选择图书状态">
            <el-option
                v-for="(item,index) in tushuzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="图书状态" prop="tushuzhuangtai">
	      <el-input v-model="ruleForm.tushuzhuangtai"
                placeholder="图书状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="图书简介" prop="tushujianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tushujianjie" label="图书简介" prop="tushujianjie">
                    <span v-html="ruleForm.tushujianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          kejietianshu: [
                { required: true, message: '可借天数不能为空', trigger: 'blur' },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chubanshe = true;
          ...
          if(o=='tushuzhuangtai'){
            this.ruleForm.tushuzhuangtai = obj[o];
	    this.ro.tushuzhuangtai = true;
            continue;
          }
          if(o=='kejietianshu'){
	...
	this.ruleForm.tushujianjie = this.ruleForm.tushujianjie.replace(reg,'../../../ssm1428t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
