<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借阅日期" prop="jieyueriqi">
          <el-input v-model="ruleForm.jieyueriqi" 
              placeholder="借阅日期" clearable  :readonly="ro.jieyueriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借阅日期" prop="jieyueriqi">
              <el-input v-model="ruleForm.jieyueriqi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="应还日期" prop="yinghairiqi">
          <el-input v-model="ruleForm.yinghairiqi" 
              placeholder="应还日期" clearable  :readonly="ro.yinghairiqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="应还日期" prop="yinghairiqi">
              <el-input v-model="ruleForm.yinghairiqi" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="归还日期" prop="guihairiqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guihairiqi" label="归还日期" prop="guihairiqi">
