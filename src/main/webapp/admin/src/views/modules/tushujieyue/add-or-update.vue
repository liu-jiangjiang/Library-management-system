<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="借阅单号" prop="jieyuedanhao">
            <el-input v-model="ruleForm.jieyuedanhao" 
                placeholder="借阅单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieyuedanhao" label="借阅单号" prop="jieyuedanhao">
              <el-input v-model="ruleForm.jieyuedanhao" 
                placeholder="借阅单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书编号" prop="tushubianhao">
          <el-input v-model="ruleForm.tushubianhao" 
              placeholder="图书编号" clearable  :readonly="ro.tushubianhao"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书分类" prop="tushufenlei">
          <el-input v-model="ruleForm.tushufenlei" 
              placeholder="图书分类" clearable  :readonly="ro.tushufenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图书分类" prop="tushufenlei">
              <el-input v-model="ruleForm.tushufenlei" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可借天数" prop="kejietianshu">
          <el-input v-model="ruleForm.kejietianshu" 
              placeholder="可借天数" clearable  :readonly="ro.kejietianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可借天数" prop="kejietianshu">
              <el-input v-model="ruleForm.kejietianshu" 
                placeholder="可借天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可借数量" prop="kejieshuliang">
          <el-input v-model="ruleForm.kejieshuliang" 
              placeholder="可借数量" clearable  :readonly="ro.kejieshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可借数量" prop="kejieshuliang">
              <el-input v-model="ruleForm.kejieshuliang" 
                placeholder="可借数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="借阅日期" prop="jieyueriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieyueriqi" label="借阅日期" prop="jieyueriqi">
              <el-input v-model="ruleForm.jieyueriqi" 
                placeholder="借阅日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借阅天数" prop="jieyuetianshu">
          <el-input v-model="ruleForm.jieyuetianshu" 
              placeholder="借阅天数" clearable  :readonly="ro.jieyuetianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借阅天数" prop="jieyuetianshu">
              <el-input v-model="ruleForm.jieyuetianshu" 
                placeholder="借阅天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="应还日期" prop="yinghairiqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.yinghairiqi" 
                type="date"
                placeholder="应还日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yinghairiqi" label="应还日期" prop="yinghairiqi">
              <el-input v-model="ruleForm.yinghairiqi" 
                placeholder="应还日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="借阅状态" prop="jieyuezhuangtai">
          <el-select v-model="ruleForm.jieyuezhuangtai" placeholder="请选择借阅状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="借阅状态" prop="jieyuezhuangtai">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jieyuedanhao'){
            this.ruleForm.jieyuedanhao = obj[o];
	    this.ro.jieyuedanhao = true;
            continue;
          }
          if(o=='tushubianhao'){
	    ...
	    this.ro.kejietianshu = true;
          ...
          if(o=='kejieshuliang'){
            this.ruleForm.kejieshuliang = obj[o];
	    this.ro.kejieshuliang = true;
            continue;
          }
          if(o=='jieyueriqi'){
	    ...
	    this.ro.jieyuetianshu = true;
          ...
          if(o=='yinghairiqi'){
            this.ruleForm.yinghairiqi = obj[o];
	    this.ro.yinghairiqi = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.shenfenzheng!=''&&json.shenfenzheng){
          ...
          this.$message.error(data.msg);
            ...
            this.jieyuezhuangtaiOptions = "借阅,已归还".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
